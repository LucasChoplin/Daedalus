...
typedef struct{
    int mapID; /**< ID de la salle où se trouve le mob */
    int spriteID; /**< ID du sprite du mob */
    int xTile; /**< position x du mob en tuile */
    int yTile; /**< position y du mob en tuile */
    int hp; /**< points de vie du mob */
    int max_hp; /**< points de vie maximum du mob */
    int attack; /**< points d'attaque du mob */
    int speed; /**< vitesse du mob */
} Mob;
